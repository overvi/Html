...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var stepper = new (bs_stepper__WEBPACK_IMPORTED_MODULE_0___default())(stepperEl);
    ...
    stepperEl.addEventListener("show.bs-stepper", function (event) {
        if (event.detail.indexStep == 2) {
            interactive === null || interactive === void 0 ? void 0 : interactive.classList.add("hidden");
        }
        else {
            interactive === null || interactive === void 0 ? void 0 : interactive.classList.remove("hidden");
        }
    });
});
