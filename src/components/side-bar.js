...
style="transform-style : preserve-3d"
  class="bg-white side-narrow w-[60px] dark:bg-storm-600 mb-3 rounded-full p-2  min-h-[80vh] h-fit fixed flex justify-center items-center"
>
  <div style='transform-style : preserve-3d' class="space-y-10 flex flex-col items-center">
    ...
    >
      <svg
        class="max-w-full  theme-dark-svg"
        width="28"
        height="28"
        viewBox="0 0 28 28"
        fill="#767676"
    ...
    <a href="/booking" class="side-tab">
      <svg
        class="max-w-full  h-auto !active &&  theme-dark-svg "
        width="28"
        height="28"
        viewBox="0 0 28 28"
        fill="none"
    ...
    <a  class="side-tab">
      <div>
        <svg
          width="28"
          height="28"
          class='theme-dark-svg max-w-full'
          viewBox="0 0 28 28"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
