...
<path d="M9.23039 6.28906H21.4994C21.7758 6.28906 22 6.5176 22 6.79946V33.5867C22 38.7821 17.863 42.9974 12.7696 42.9974H9.23039C4.1345 42.9974 0 38.7796 0 33.5867V15.6998C0 10.5043 4.13699 6.28906 9.23039 6.28906Z" fill="#F9B233"/>
<path opacity="0.31" d="M18.1523 29.6145C17.6143 29.6678 17.2208 30.1579 17.2208 30.7089V30.8181C17.2208 34.1903 14.7874 37.0801 11.557 37.494C11.5072 37.5016 11.3777 37.5092 11.2158 37.5143C10.6504 37.5371 10.2046 38.012 10.2046 38.5884C10.2046 39.2004 10.7077 39.6905 11.308 39.66C11.5844 39.6473 11.816 39.6321 11.8858 39.6219C16.1224 39.0455 19.288 35.2518 19.288 30.8384V30.6632C19.288 30.0462 18.77 29.5535 18.1523 29.6145Z" fill="white"/>
<path d="M6.79932 3.21682V9.10041C6.79932 9.44322 7.0708 9.72001 7.40704 9.72001C7.74328 9.72001 8.01476 9.44322 8.01476 9.10041V3.21682H15.6138V9.10295C15.6138 9.44576 15.8852 9.72255 16.2215 9.72255C16.5577 9.72255 16.8292 9.44576 16.8292 9.10295V3.21682C16.8292 1.99287 15.8554 1 14.6549 1H8.97616C7.77566 1 6.80181 1.99287 6.80181 3.21682H6.79932Z" fill="#2FAC66" stroke="#2FAC66" stroke-width="0.75" stroke-miterlimit="10"/>
</svg>
              </div>
            </div>
            ...
            <div
              class="flex items-center gap-5 border border-[#A1A1A1]/[63.14%] rounded-full"
            >
              <button class="toggle-color-dark rounded-full">
                <div class="rounded-full p-2 w-fit">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                      class='theme-color-f'
                  ...
                  >
                    <path
                      d="M9.0002 18.9994C9.0002 19.8394 9.1302 20.6594 9.3702 21.4194C5.5302 20.0894 2.6302 16.5594 2.3302 12.4294C2.0302 8.03938 4.5602 3.93938 8.6502 2.21938C9.7102 1.77938 10.2502 2.09938 10.4802 2.32938C10.7002 2.54938 11.0102 3.07938 10.5702 4.08938C10.1202 5.12938 9.9002 6.22938 9.9002 7.36938C9.9102 9.40938 10.7102 11.2994 12.0102 12.7494C10.1802 14.2094 9.0002 16.4694 9.0002 18.9994Z"
                      fill="#888888"
                    />
                    <path
                      opacity="0.4"
              ...
              ><button class="toggle-color-light  rounded-full">
                <div class="rounded-full p-2 w-fit">
                  <svg
                    width="24"
                    height="24"
                  ...
                  <div dir="rtl" class="font-yekan w-[25rem] p-2 rounded-full">
                    <div>
                      <div class="flex justify-between items-center w-full">
                        ...
                        <div
                          class="flex w-fit border-0 next shadow-none items-center px-4 py-2 gap-2 group text-green-600 rounded-full font-bold"
                        >
                          <svg
                            class="rtl:hidden"
                            width="24"
                    ...
                    <div>
                      ...
                      <div class="mt-2 border-y py-3">
                        <div class="flex justify-between items-center">
                          ...
                          <div>
                            <p class="font-medium">fdsafdasfdasfdsa</p>
                          </div>
                        </div>
                      ...
                      <div class="mt-2 py-3">
                        <div class="flex justify-between items-center">
                          ...
                          <div class="font-medium">fdsafdasfdasfdsa</div>
                        </div>
                        <div class="flex justify-end">
                          <p>Sorem</p>
                        </div>
                  ...
                  >
                    <div class="font-yekan w-[24rem] rounded-full">
                      ...
                      <div class="py-3 text-right">
                        <p
                          data-i18n="customerInfo"
                          class="font-bold text-gray-500 text-md"
                        ></p>
                        <p>Hjys</p>
                      </div>
                      <div
                        class="mt-3 *:space-y-2 font-medium text-sm flex items-center justify-between gap-7"
                      >
                ...
                >
                  ...
                  >
                    <div class="font-yekan w-[25rem] p-2 pb-20 rounded-full">
                      <div>
                        <div
                          class="flex pb-3 items-center justify-between border-b text-right"
                        >
                          <p
                        ...
                        >
                          <div>
                            ...
                            ></p>
                            <p class="mt-2 text-xs text-[#767676]">1204/2014</p>
                          </div>
                          <div>
                            <svg
                              width="18"
